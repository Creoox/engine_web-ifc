...
namespace webifc::geometry
{
	...
	private:
		...
		// Compute a planar spiral from a curvature function kappa(s) and append the sampled points (and tangents) to `curve`.
		// Used by the IFC 4.3 cosine, sine, and polynomial spiral cases in ComputeCurve. Mirrors IFCCLOTHOID's body with a generalised, 
