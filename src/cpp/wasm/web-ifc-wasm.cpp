...
EMSCRIPTEN_BINDINGS(my_module)
{
    ...
    emscripten::value_object<webifc::manager::LoaderSettings>("LoaderSettings")
        ...
        .field("MAX_CURVE_SEGMENT_LENGTH", &webifc::manager::LoaderSettings::MAX_CURVE_SEGMENT_LENGTH)
        .field("MAX_CURVE_SAGITTA_ERROR", &webifc::manager::LoaderSettings::MAX_CURVE_SAGITTA_ERROR)
        .field("MAX_ADAPTIVE_CURVE_SEGMENTS", &webifc::manager::LoaderSettings::MAX_ADAPTIVE_CURVE_SEGMENTS)
        .field("MIN_ARC_SEGMENTS", &webifc::manager::LoaderSettings::MIN_ARC_SEGMENTS)
